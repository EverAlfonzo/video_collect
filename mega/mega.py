...
class Mega:
    def __init__(self, options=None):
        ...
        self.timeout = 900  # max secs to wait for resp from api requests
        self.sid = None
    ...
    def upload(self, filename, dest=None, dest_filename=None):
        ...
        # i have to customized this for InMemoryUploadedFile submittion
        with filename.file as input_file:
            ...
            dest_filename = dest_filename or os.path.basename(filename.name)
